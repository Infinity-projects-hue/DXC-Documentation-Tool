...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center gap-1 rounded-2xl bg-muted/70 p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
